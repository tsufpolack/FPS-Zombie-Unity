...
namespace EnemyAI
{
	...
	public class StateController : MonoBehaviour
	{
		...
		[HideInInspector] public bool aligned;                      // Is the NPC orientation aligned to the target?
		...
		void Awake()
		{
			...
			// Automatically find the player and set it as aimTarget
			GameObject player = GameObject.FindGameObjectWithTag("Player");
			if (player != null)
			{
				aimTarget = player.transform;
			}
			else
			{
				Debug.LogError("No GameObject with tag 'Player' found in the scene. Please ensure there is a GameObject tagged as 'Player'.");
			}
